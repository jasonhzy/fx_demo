 ...
 <div class="menu_content">
	 ...
	 <table cellspacing="2" cellpadding="5" width="100%" id="tab1">
	  ...
	  <tr>
			...
			<b>商品重量：</b><input name="goods_weight" value="<?php echo isset($rt['goods_weight']) ? $rt['goods_weight'] : '0.000';?>" size="20" type="text" /> (KB为单位)
			</td>
        </tr>
	...
	<tr>
	 ...
	 <em style="color:#FF0000">点击[+]增加一个额外分类</em>		
	  ...
	  <?php } ?>
	  <tr>
		<td class="label" valign="middle"><a href="javascript:;" class="addgallery">[+]</a>图片名称：</td>
		<td> <input type="text" name="photo_gallery_desc[]" value=""/>
		上传图片
		<input type="hidden" name="photo_gallery_url[]" id="goodsgallery" value=""/>
		<iframe id="iframe_t" name="iframe_t" border="0" src="upload.php?action=&ty=goodsgallery&tyy=goods&files=" scrolling="no" width="445" frameborder="0" height="25"></iframe>
		</td>
	 	</tr>
