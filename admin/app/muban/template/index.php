<style type="text/css">
	table td li{ position:relative; margin-right:10px; cursor:pointer; width:200px; height:250px; float:left; border:1px solid #ccc; background:#ededed; float:left; overflow:hidden}
