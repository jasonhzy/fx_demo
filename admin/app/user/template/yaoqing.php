...
<div class="contentbox">
	 ...
	 <tr>
		<th colspan="4" align="left" style="text-align:left">邀请用户列表</th>
	</tr>
	...
	<!--<td>
	<a href="user.php?type=yaoqinginfo&id=<?php echo $row['id'];?>" title="编辑"><img src="<?php echo $this->img('icon_edit.gif');?>" title="编辑"/></a>&nbsp;
