...
?>
<tr>
<td><?php echo $row['user_id'];?><input type="checkbox" name="quanxuan" id="<?php echo $row['user_name'];?>" value="<?php echo $row['user_id'];?>" class="uids"/></td><td><?php echo $row['user_name'];?></td><td><?php echo $row['email'];?></td><td><?php echo date('Y-m-d',$row['reg_time']);?></td><td><?php echo $row['birthday'];?></td>
</tr>
<?php } } ?>
<tr>
<td colspan="5">
