...
$GLOBALS['picdir'] = SYS_PATH_PHOTOS.(isset($_REQUEST['tyy'])&&!empty($_REQUEST['tyy'])? trim($_REQUEST['tyy']) : trim($_REQUEST['ty'])).'/'.date('Ym',mktime()).'/'; 

if(isset($_POST)&&!empty($_POST)){
	$name = $app->action('upload','upload','sf_upfile',$GLOBALS['picdir']);
	if(!empty($name)) $action	= "show";
	$GLOBALS['picurl'] = 'photos/'.(isset($_REQUEST['tyy'])&&!empty($_REQUEST['tyy'])? trim($_REQUEST['tyy']) : trim($_REQUEST['ty'])).'/'.date('Ym',mktime()).'/'.$name;
}
