...
<div id="main">
	<div class="mainhead" style="margin:5px; margin-top:0px; border:1px solid #ededed;border-radius:5px; background:#FFF">
		...
		<p><b>市场价：</b><font color="#FF3399"><del>￥<?php echo str_replace('.00','',$rt['goodsinfo']['shop_price']);?></del></font></p>
		<p><b>折扣价：</b><span style="color:#D30202">￥<?php echo str_replace('.00','',$rt['goodsinfo']['pifa_price']);?></span></p>
		<p><b>所需积分：</b><span style="color:#D30202"><?php echo $rt['goodsinfo']['need_jifen'];?></span></p>
