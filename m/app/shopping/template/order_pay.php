...
<div id="main" style="padding:5px; padding-top:0px; min-height:300px">
	...
	<div class="goodslist">
		...
		<tr>
			...
			<p style="padding-top:5px; padding-left:10px; font-size:14px;">订单折扣总金额：<font color="#FF0000"><b>￥<?php echo $orderinfo['order_amount'];?></b></font></p>
			<p style="padding-top:5px; padding-left:10px; font-size:14px;">支付方式：<b><?php echo $orderinfo['pay_name'];?></b>&nbsp;&nbsp;配送方式：<b>快递免邮</b></p>
		...
		<?php if($orderinfo['pay_status'] !='1'){?>
		<div>
			<a href="<?php echo ADMIN_URL.'mycart.php?type=fastpay&oid='.$orderinfo['order_id'];?>" class="btn-buy button ui-btn ui-btn-text-only"><span class="ui-btn-text">立即支付</span></a>
