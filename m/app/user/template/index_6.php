...
<!--	<div data-role="navbar" class="ui-navbar ui-mini" role="navigation">
  	...
  	<div data-role="content" class="ui-content" role="main">
		...
		共有<font color="#fe0000"><?php echo $rt['gzcount']*5+1500;?></font>人关注了我们，你是第<font color="#fe0000"><?php echo $rt['userinfo']['subscribe_rank']*5+750;?></font>个！<!--<br/>你的邀请人是：<font color="#00761d"><?php echo empty($rt['tjren']) ? '官网':$rt['tjren'];?></font>-->
		</p>
  </div>
