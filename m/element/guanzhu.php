...
<div style=" position:relative;height:44px; line-height:44px; background:url(<?php echo $this->img('gzbg.png');?>) repeat; position:fixed; top:0px; left:0px; width:100%; z-index:9999">
	...
	<a href="<?php echo ADMIN_URL.'art.php?id=18';?>" style=" position:absolute; right:10px; top:6px; z-index:99; cursor:pointer; height:35px;"><img src="<?php echo $this->img('guanzhu.png');?>" /></a>
</div>
<?php } ?>